...
public:
    ...
    static TSharedPtr<FJsonObject> SerializePinToJson(UEdGraphPin* Pin);
    static TSharedPtr<FJsonObject> SerializeNodeToJson(UEdGraphNode* Node, bool bIncludePins = true);
    static TSharedPtr<FJsonObject> SerializeGraphToJson(UEdGraph* Graph);
