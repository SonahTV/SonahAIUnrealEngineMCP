...
private:
    ...
    TSharedPtr<FJsonObject> HandleAssignAnimBlueprint(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleSetMovementParam(const TSharedPtr<FJsonObject>& Params);
