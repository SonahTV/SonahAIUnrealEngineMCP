...
class UnrealConnection:
    ...
    def receive_full_response(self, sock, buffer_size=4096) -> bytes:
        ...
        chunks = []
        sock.settimeout(30)  # 30 second timeout for blueprint operations
        try:
            while True:
...
mcp = FastMCP(
    ...
    description="SonahAI Unreal Engine MCP — 95+ tools for fully autonomous UE5 development via Model Context Protocol",
